        ...
        <div className={style.container}>
            <div className={style.wrapper}>
                ...
                <div className={style.tables}>
                    ...
                    <Table title='TECHSTACK' icon={Comp1} description='Java, Delphi, Android, iOS, .NET (C#), ASP HTML, CSS, JavaScript, MS SQL SERVER, Angular, Amazon Web Services.' />
                    <Table title='RESULTS' icon={Comp2} description='Experience in software development, testing, implementation and maintenance.' />
                </div>
            </div>
        </div>
    )
