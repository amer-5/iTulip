      ...
      <div className={style.wrapper}>
        ...
        <div className={style.table}>
          <Table
            icon={repeat}
            title="CONTINUITEIT"
            description="Van oplossingen staat hoog in het vaandel"
          />
          <Table
            icon={computer}
          ...
          <Table
            icon={hourglass}
            title="ERVARING"
            description="Met projecten in Nederland, VK, Zweden, Duistland, Belgie"
          />
          ...
          <Table
            icon={chair}
            title="ON-SITE"
            description="Binnen een paar weken"
            bonus="*wij regelen zelf de vergunningen"
          />
        </div>
      </div>
    </div>
